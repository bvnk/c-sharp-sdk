...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MerchantChannelRequest :  IEquatable<MerchantChannelRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MerchantChannelRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MerchantChannelRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MerchantChannelRequest" /> class.
        /// </summary>
        ...
        /// <param name="payCurrency">Cryptocurrency code that the channel will operate on. (required) (default to &quot;ETH&quot;).</param>
        ...
        public MerchantChannelRequest(string merchantId = "0a12a214-1619-43fa-9be1-0029f6a440a0", string payCurrency = "ETH", string displayCurrency = "EUR", string reference = "c1b933d5-3354-4f83-a05f-0b53f1be85f2")
        {
            // to ensure "merchantId" is required (not null)
            if (merchantId == null)
            {
                throw new InvalidDataException("merchantId is a required property for MerchantChannelRequest and cannot be null");
            }
            else
            {
            ...
            if (payCurrency == null)
            {
                throw new InvalidDataException("payCurrency is a required property for MerchantChannelRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("displayCurrency is a required property for MerchantChannelRequest and cannot be null");
            }
            else
            {
            ...
            if (reference == null)
            {
                throw new InvalidDataException("reference is a required property for MerchantChannelRequest and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Cryptocurrency code that the channel will operate on.</value>
        ...
        {
            return this.Equals(input as MerchantChannelRequest);
        }

        /// <summary>
        /// Returns true if MerchantChannelRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MerchantChannelRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MerchantChannelRequest input)
        {
            if (input == null)
                return false;
