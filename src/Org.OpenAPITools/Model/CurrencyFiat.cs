...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CurrencyFiat :  IEquatable<CurrencyFiat>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrencyFiat" /> class.
        /// </summary>
        /// <param name="code">code.</param>
        /// <param name="depositFee">depositFee.</param>
        /// <param name="fiat">fiat (default to true).</param>
        /// <param name="icon">icon.</param>
        /// <param name="id">id.</param>
        /// <param name="name">name.</param>
        /// <param name="options">options.</param>
        /// <param name="pricePrecision">pricePrecision (default to 2).</param>
        /// <param name="protocols">protocols.</param>
        /// <param name="quantityPrecision">quantityPrecision (default to 2).</param>
        /// <param name="supportsDeposits">supportsDeposits (default to true).</param>
        /// <param name="supportsWithdrawals">supportsWithdrawals (default to true).</param>
        /// <param name="withdrawalFee">withdrawalFee.</param>
        /// <param name="withdrawalParameters">withdrawalParameters.</param>
        public CurrencyFiat(string code = default(string), decimal depositFee = default(decimal), bool fiat = true, string icon = default(string), long id = default(long), string name = default(string), Object options = default(Object), int pricePrecision = 2, List<Object> protocols = default(List<Object>), int quantityPrecision = 2, bool supportsDeposits = true, bool supportsWithdrawals = true, decimal withdrawalFee = default(decimal), List<Object> withdrawalParameters = default(List<Object>))
        {
            this.Code = code;
        ...
        {
            return this.Equals(input as CurrencyFiat);
        }

        /// <summary>
        /// Returns true if CurrencyFiat instances are equal
        /// </summary>
        /// <param name="input">Instance of CurrencyFiat to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CurrencyFiat input)
        {
            if (input == null)
                return false;
