...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MerchantChannel :  IEquatable<MerchantChannel>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MerchantChannel" /> class.
        /// </summary>
        ...
        public List<AlternativeAddress> Alternatives { get; set; }
        ...
        {
            return this.Equals(input as MerchantChannel);
        }

        /// <summary>
        /// Returns true if MerchantChannel instances are equal
        /// </summary>
        /// <param name="input">Instance of MerchantChannel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MerchantChannel input)
        {
            if (input == null)
                return false;
