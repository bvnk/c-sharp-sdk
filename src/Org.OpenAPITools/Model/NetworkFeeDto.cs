...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NetworkFeeDto :  IEquatable<NetworkFeeDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NetworkFeeDto" /> class.
        /// </summary>
        ...
        public NetworkFeeDto(string paidCurrency = default(string), decimal paidAmount = default(decimal), string displayCurrency = default(string), decimal displayAmount = default(decimal))
        {
        ...
        {
            return this.Equals(input as NetworkFeeDto);
        }

        /// <summary>
        /// Returns true if NetworkFeeDto instances are equal
        /// </summary>
        /// <param name="input">Instance of NetworkFeeDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NetworkFeeDto input)
        {
            if (input == null)
                return false;
