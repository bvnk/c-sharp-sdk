...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CurrencyDto :  IEquatable<CurrencyDto>, IValidatableObject
    {
        ...
        /// <param name="fiat">Is a fiat currency. (default to false).</param>
        /// <param name="icon">The icon of the currency..</param>
        /// <param name="id">The ID of the currency..</param>
        /// <param name="name">The currency name..</param>
        /// <param name="options">options.</param>
        /// <param name="pricePrecision">The precision of decimal points for the currency. (default to 5).</param>
        /// <param name="protocols">The alternative protocols array..</param>
        /// <param name="quantityPrecision">The precision of decimal points for the currency displayed. (default to 5).</param>
        /// <param name="supportsDeposits">Is deposits for this currency supported. (default to false).</param>
        /// <param name="supportsWithdrawals">Is withdrawals for this currency supported (default to false).</param>
